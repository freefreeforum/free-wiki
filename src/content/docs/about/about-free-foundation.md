...
The Foundation's operational responsibilities currently include:
...
FREE is in the process of transitioning from a single-chapter pilot to a multi-chapter federation. That transition has implications for how the Foundation is governed.
