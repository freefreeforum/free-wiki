...
FREE has several entry points depending on what you're looking for. None of them require formal membership or credentials. Pick the one that matches where you are.

## If You're New to FREE

Start with the newsletter at [freefreeforum.org](https://freefreeforum.org) and the Substack. Both will give you a sense of what FREE is doing, the kinds of conversations happening in the network, and the people involved. If you want to read more deeply into the economic frame, Clara Mattei's books are a strong starting point.
...
If you're part of an organization that aligns with FREE's frame, FREE Foundation is interested in talking with you about how your work and the network can support each other. FREE's intent is federation, not absorption. Existing assemblies, cooperatives, political education projects, and movement organizations are all natural partners.

Reach out via the contact channel below to start a conversation.

## If You Have Skills to Contribute
...
The fastest way to reach FREE Foundation right now is through the contact form at [freefreeforum.org](https://freefreeforum.org). A more direct channel and a Discord server are in development, and links will be added here as those come online.
